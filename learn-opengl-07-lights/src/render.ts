...
export class Renderer {
  ...
  #draw(): void {
    ...
    this.#gl.uniform1f(this.#triangleProgram.uniforms.uLightSpecularStrength, 0.5);
    this.#gl.uniform1f(this.#triangleProgram.uniforms.uMaterialShininess, 1024);

    this.#gl.uniform3fv(this.#triangleProgram.uniforms.uLightColor, this.#lightAmbientColor);
    this.#gl.uniform3fv(this.#triangleProgram.uniforms.uLightPosition, this.#lights[0].position);
